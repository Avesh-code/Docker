...
* `docker logs <containerid>` : using this command we can see the logs of the container running.
* `nohup docker attach <containerid> & ` : this will store the logs into nohup.out file present in that directory.
